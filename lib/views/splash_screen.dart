               ...
               child: Center(
                 child: Container(
                   ...
                   decoration: BoxDecoration(
                       ...
                       boxShadow: <BoxShadow>[BoxShadow(color: AppTheme.COLOR_REDISH, spreadRadius: -2, blurRadius: 20, offset: Offset(0, 10))],

                       image: DecorationImage(image: AssetImage('assets/ic_attend.jpg'),fit: BoxFit.cover,
                           colorFilter: ColorFilter.mode(AppTheme.PRIMARY_COLOR_BLUE_OPS, BlendMode.difference))
                   ),
